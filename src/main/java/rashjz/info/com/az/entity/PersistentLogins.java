...
@NamedQueries({
    ...
    @NamedQuery(name = "PersistentLogins.findByEmail", query = "SELECT p FROM PersistentLogins p WHERE p.email = :email"),
...
public class PersistentLogins implements Serializable {
    ...
    public PersistentLogins(String series, String email, String token, Date lastUsed) {
        this.series = series;
        this.email = email;
        this.token = token;
