    ...
    <div class="check">
        <div class="col-md-3 cart-total">
            <div style=".list-group-item.active {background-color:  red;}" class="list-group">
                ...
                <a href="checkout?typeId=1" id="shortlink1" data-type="1" class="list-group-item ">İcrada<span
                        class="sr-only">(current)</span></a>
                <a href="checkout?typeId=2" id="shortlink2" data-type="2" class="list-group-item ">Çatdırılıb<span
                        class="sr-only">(current)</span></a>
                <a href="checkout?typeId=3" id="shortlink3" data-type="3" class="list-group-item ">Səbətdə<span
                        class="sr-only">(current)</span></a>
            </div>
                        ...
                        <div class="cart-sec simpleCart_shelfItem">
                            <div class="cart-item cyc">
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <img src="${pageContext.request.contextPath}/resources/images/no-image-crop.png"
                            ...
                            <div class="cart-item-info">
                                ...
                                <div class="fgh">
                                    ...
                                    <a href="<c:url value="view?code=${order.productId.PId}"/>"
                                       style="margin-left: 3px;">
                                        <span class="glyphicon glyphicon-zoom-in"></span>
                                    </a>
                                    <a data-toggle="modal" data-id="${order.productId.PId}" data-backdrop="static"
                                       style="margin-left: 3px;"
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-5">
                            <select id="metroCombobox" class="selectpicker">
                                <option value="Həzi Aslanov">Həzi Aslanov</option>
                                <option value="Əhmədli2">Əhmədli</option>
                                ...
                                <option value="Azadlıq">Azadlıq prospekti</option>
...
<script>
    ...
    function orderDelivery() {
        ...
        //var metroText = $("#metroCombobox option[value=metroID]").text();
